...
# use file-extension c for "c-only"-files
SRCARM = main.c timer.c lcd.c str.c delay.c tp.c font.c uart.c pll.c printf.c heap.c gui.c
...
ASRCARM = crt0.S stra.S lcda.S delaya.S
...
CINCS = -I$(WINARM_DIR)/arm-elf/include
...
program: $(TARGET).hex
	load21xx.exe 2103 $(TARGET).hex $(LPC21ISP_PORT)
	
# Program the device.  
unused-program: $(TARGET).hex
	@echo
